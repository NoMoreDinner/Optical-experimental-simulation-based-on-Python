...
# Form implementation generated from reading ui file 'ShowHtml.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, Form):
        ...
        self.webEngineView.setGeometry(QtCore.QRect(0, 0, 1920, 1080))
...
class MainApp(QMainWindow , Ui_MainWindow):
    ...
    def showhtml(self, path):
        self.webEngineView.load(QtCore.QUrl.fromLocalFile(path))
