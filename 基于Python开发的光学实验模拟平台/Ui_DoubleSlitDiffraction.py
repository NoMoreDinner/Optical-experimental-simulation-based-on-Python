...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(820, -10, 411, 71))
...
"}")
        ...
        self.SpinBox_x.setMinimum(0.0)
        self.SpinBox_x.setMaximum(100.0)
        self.SpinBox_x.setSingleStep(0.0001)
...
"margin-bottom:3px;\n"
"}")
        self.SpinBox_d.setDecimals(4)
        self.SpinBox_d.setMinimum(0.0)
        self.SpinBox_d.setMaximum(100.0)
        self.SpinBox_d.setSingleStep(0.0001)
...
"}")
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(40, 670, 411, 376))
...
"}")
        ...
        # self.formLayoutWidget_4.setGeometry(QtCore.QRect(570, 80, 891, 591))
        ...
        # self.formLayoutWidget_5.setGeometry(QtCore.QRect(570, 680, 891, 391))
        ...
        self.label_PrinciplePicture.setGeometry(QtCore.QRect(1490, 690, 401, 291))
        self.label_PrinciplePicture.setObjectName("label_PrinciplePicture")
        self.pushButton_start_2 = QtWidgets.QPushButton(MainWindow)
        self.pushButton_start_2.setGeometry(QtCore.QRect(1590, 500, 200, 60))
...
"}")
        ...
        self.pushButton_start.setGeometry(QtCore.QRect(1600, 990, 200, 60))
...
"border: 1px solid black;")
        ...
        self.label_PrinciplePicture.setPixmap(QtGui.QPixmap("img/双缝衍射原理图.jpg").scaled(401, 291))

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Form"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:30pt; font-weight:600;\">双缝衍射演示实验</span></p></body></html>"))
        ...
        self.label_d.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:20pt;\">距离(cm)</span></p></body></html>"))
        ...
        self.label_x.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:20pt;\">缝宽(cm)</span></p></body></html>"))
        ...
        self.label_PrinciplePicture.setText(_translate("MainWindow", "<html><head/><body><p><img src=\"img/双缝衍射原理图.jpg\"/></p></body></html>"))
        ...
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">1.理解双缝衍射的实验原理。</span></p><p><span style=\" font-size:18pt;\">2.了解双缝衍射的成像规律。</span></p><p><br/></p></body></html>"))
